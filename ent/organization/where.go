...
func HasProvidersWith(preds ...predicate.Provider) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
// HasThirdPartyAuths applies the HasEdge predicate on the "third_party_auths" edge.
func HasThirdPartyAuths() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasThirdPartyAuthsWith applies the HasEdge predicate on the "third_party_auths" edge with a given conditions (other predicates).
func HasThirdPartyAuthsWith(preds ...predicate.ThirdPartyAuth) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := newThirdPartyAuthsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
