...
type OrganizationEdges struct {
	...
	// ThirdPartyAuths holds the value of the third_party_auths edge.
	ThirdPartyAuths []*ThirdPartyAuth `json:"third_party_auths,omitempty"`
...
func (e OrganizationEdges) ProvidersOrErr() ([]*Provider, error) {
	if e.loadedTypes[0] {
...
// ThirdPartyAuthsOrErr returns the ThirdPartyAuths value or an error if the edge
// was not loaded in eager-loading.
func (e OrganizationEdges) ThirdPartyAuthsOrErr() ([]*ThirdPartyAuth, error) {
	if e.loadedTypes[1] {
		return e.ThirdPartyAuths, nil
	}
	return nil, &NotLoadedError{edge: "third_party_auths"}
}
...
func (o *Organization) QueryProviders() *ProviderQuery {
	return NewOrganizationClient(o.config).QueryProviders(o)
}

// QueryThirdPartyAuths queries the "third_party_auths" edge of the Organization entity.
func (o *Organization) QueryThirdPartyAuths() *ThirdPartyAuthQuery {
	return NewOrganizationClient(o.config).QueryThirdPartyAuths(o)
}
