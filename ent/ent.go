...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			customhostname.Table: customhostname.ValidColumn,
			function.Table:       function.ValidColumn,
			networkban.Table:     networkban.ValidColumn,
			organization.Table:   organization.ValidColumn,
			pgsodiumconfig.Table: pgsodiumconfig.ValidColumn,
			project.Table:        project.ValidColumn,
			provider.Table:       provider.ValidColumn,
			secret.Table:         secret.ValidColumn,
			thirdpartyauth.Table: thirdpartyauth.ValidColumn,
			typescripttype.Table: typescripttype.ValidColumn,
